...
require (
	github.com/bbredesen/go-vk v0.0.1
	github.com/bbredesen/vkm v0.2.2
	github.com/udhos/gwob v0.0.0-20200524213453-619810f75817
	golang.org/x/sys v0.6.0
)

require github.com/bbredesen/win32-toolkit v0.0.0-20230303234304-25b01e7ba2d4

require github.com/chewxy/math32 v1.10.1 // indirect

replace github.com/bbredesen/go-vk v0.0.1 => ./vk
