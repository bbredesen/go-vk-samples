...
func loadImage() ([]byte, uint32, uint32, vk.Format) {
	...
	fname := "textures/viking_room.png"
...
func (app *App_06) createTextureImage() {
...
func (app *App_06) destroyTextureImage() {
...
func (app *App_06) createImage(width, height uint32, format vk.Format, tiling vk.ImageTiling, usage vk.ImageUsageFlags, memProps vk.MemoryPropertyFlags) (image vk.Image, imageMemory vk.DeviceMemory) {
...
func (app *App_06) copyBufferToImage(buffer vk.Buffer, image vk.Image, width, height uint32) {
...
func (app *App_06) transitionImageLayout(image vk.Image, format vk.Format, oldLayout, newLayout vk.ImageLayout) {
	cb := app.beginSingleTimeCommands()
