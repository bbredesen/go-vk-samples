...
func (app *App_06) createDepthResources() {
...
func (app *App_06) findDepthFormat() vk.Format {
...
func (app *App_06) findSupportedFormat(candidates []vk.Format, tiling vk.ImageTiling, features vk.FormatFeatureFlags) vk.Format {
...
func (app *App_06) cleanupDepthResources() {
