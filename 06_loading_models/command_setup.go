...
// the screen.
func (app *App_06) createCommandPool() {
...
func (app *App_06) destroySyncObjects() {
...
func (app *App_06) recordCommandBuffer(buffer vk.CommandBuffer, imageIndex uint32) {
	...
	vk.CmdBindIndexBuffer(buffer, app.indexBuffer, 0, vk.INDEX_TYPE_UINT32)
...
func (app *App_06) beginSingleTimeCommands() vk.CommandBuffer {
...
func (app *App_06) endSingleTimeCommands(buf vk.CommandBuffer) {
