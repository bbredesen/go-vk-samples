...
func (app *App_04) createTextureImage() {
...
func (app *App_04) destroyTextureImage() {
...
func (app *App_04) createImage(width, height uint32, format vk.Format, tiling vk.ImageTiling, usage vk.ImageUsageFlags, memProps vk.MemoryPropertyFlags) (image vk.Image, imageMemory vk.DeviceMemory) {
...
func (app *App_04) copyBufferToImage(buffer vk.Buffer, image vk.Image, width, height uint32) {
...
func (app *App_04) transitionImageLayout(image vk.Image, format vk.Format, oldLayout, newLayout vk.ImageLayout) {
	cb := app.beginSingleTimeCommands()
...
func (app *App_04) createTextureImageView() {
	app.textureImageView = app.createImageView(app.textureImage, vk.FORMAT_R8G8B8A8_SRGB)
}

func (app *App_04) createTextureSampler() {
