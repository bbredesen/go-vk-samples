...
func (app *App_04) createGraphicsPipeline() {
...
func (app *App_04) createRenderPass() {
...
func (app *App_04) createFramebuffers() {
...
func (app *App_04) destroyFramebuffers() {
...
func (app *App_04) cleanupGraphicsPipeline() {
...
func (app *App_04) createShaderModule(filename string) vk.ShaderModule {
