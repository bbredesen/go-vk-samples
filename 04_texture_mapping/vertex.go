...
var verts = []Vertex{
	{vkm.NewPt2(-0.5, -0.5), vkm.Vec3{1.0, 0.0, 0.0}, vkm.Pt2{1.0, 0.0}},
	{vkm.NewPt2(0.5, -0.5), vkm.Vec3{0.0, 1.0, 0.0}, vkm.Pt2{0.0, 0.0}},
	{vkm.NewPt2(0.5, 0.5), vkm.Vec3{0.0, 0.0, 1.0}, vkm.Pt2{0.0, 1.0}},
	{vkm.NewPt2(-0.5, 0.5), vkm.Vec3{1.0, 1.0, 1.0}, vkm.Pt2{1.0, 1.0}},
}
...
func (app *App_04) createVertexBuffer() {
...
func (app *App_04) createIndexBuffer() {
...
func (app *App_04) findMemoryType(typeFilter uint32, flags vk.MemoryPropertyFlags) uint32 {
