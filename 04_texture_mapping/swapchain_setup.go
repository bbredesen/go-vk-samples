...
func (app *App_04) createSwapchain() {
	/*
...
func (app *App_04) createSwapchainImageViews() {
	...
	for i, img := range app.swapchainImages {
		app.swapchainImageViews[i] = app.createImageView(img, app.swapchainImageFormat)
	}
}

func (app *App_04) destroyImageViews() {
...
func (app *App_04) cleanupSwapchain() {
...
func (app *App_04) recreateSwapchain() {
...
func (app *App_04) createImageView(image vk.Image, format vk.Format) vk.ImageView {
