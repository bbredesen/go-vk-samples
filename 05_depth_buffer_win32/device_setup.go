...
func (app *App_05) createInstance() {
...
func (app *App_05) isDeviceSuitable(device vk.PhysicalDevice) bool {
...
func (app *App_05) analyzeQueueFamilies(device vk.PhysicalDevice) queueFamIndices {
...
func (app *App_05) createLogicalDevice() {
