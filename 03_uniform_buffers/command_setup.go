...
// the screen.
func (app *App_03) createCommandPool() {
...
func (app *App_03) destroySyncObjects() {
...
func (app *App_03) recordCommandBuffer(buffer vk.CommandBuffer, imageIndex uint32) {
