...
func (app *App_01) isDeviceSuitable(device vk.PhysicalDevice) bool {
...
func (app *App_01) analyzeQueueFamilies(device vk.PhysicalDevice) queueFamIndices {
...
func (app *App_01) createLogicalDevice() {
