...
func (app *App_02) createInstance() {
...
func (app *App_02) selectPhysicalDevice() {
...
func (app *App_02) isDeviceSuitable(device vk.PhysicalDevice) bool {
...
func (app *App_02) checkDeviceExtensionSupport(device vk.PhysicalDevice) bool {
...
func (app *App_02) analyzeQueueFamilies(device vk.PhysicalDevice) queueFamIndices {
...
func (app *App_02) createLogicalDevice() {
