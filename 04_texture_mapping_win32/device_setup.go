...
func (app *App_04) isDeviceSuitable(device vk.PhysicalDevice) bool {
...
func (app *App_04) checkDeviceExtensionSupport(device vk.PhysicalDevice) bool {
...
func (app *App_04) analyzeQueueFamilies(device vk.PhysicalDevice) queueFamIndices {
...
func (app *App_04) createLogicalDevice() {
